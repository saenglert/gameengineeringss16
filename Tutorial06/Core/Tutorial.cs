...
namespace Fusee.Tutorial.Core
{
    ...
    public class Tutorial : RenderCanvas
    {
        ...
        public override void Init()
        {
            ...
            _renderer = new Renderer(RC, new []{"Leaves.jpg", "litsphere.jpg"});

            string standardVS = AssetStorage.Get<string>("VertexShader.vert");
            string standardPS = AssetStorage.Get<string>("PixelShader.frag");
            string twopassVS = AssetStorage.Get<string>("TwoPassVS.vert");
            string twopassPS = AssetStorage.Get<string>("TwoPassPS.frag");
            string cellVS = AssetStorage.Get<string>("CellVS.vert");
            string cellPS = AssetStorage.Get<string>("CellPS.frag");
            ITexture leaveTexture = _renderer.GetTexture("Leaves.jpg");
            ITexture sphereTexture = _renderer.GetTexture("litsphere.jpg");

            ShaderEffect standarEffect = new ShaderEffect(
                new[]
                {
                ...
                new[]
                {
                    ...
                    new EffectParameterDeclaration {Name = "texture", Value = leaveTexture},
                    new EffectParameterDeclaration {Name = "texmix", Value = 0.0f},
                });

            ShaderEffect twopass = new ShaderEffect(
                new[]
                {
                    new EffectPassDeclaration
                    {
            ...
            ShaderEffect cell = new ShaderEffect(
                new[]
                {
                    new EffectPassDeclaration
                    {
                ...
                new[]
                {
                    ...
                    new EffectParameterDeclaration {Name = "speccolor", Value = float3.Zero},
                    new EffectParameterDeclaration {Name = "ambientcolor", Value = float3.Zero},
                    new EffectParameterDeclaration {Name = "texture", Value = sphereTexture},
                    new EffectParameterDeclaration {Name = "texmix", Value = 0.0f},
                    new EffectParameterDeclaration {Name = "linewidth", Value = float2.One * 1.5f},
                    new EffectParameterDeclaration {Name = "linecolor", Value = float4.Zero},
                });

            _renderer.AddShader("standard", cell);
