...
namespace Fusee.Tutorial.Core
{
    ...
    class Renderer : SceneVisitor
    {
        ...
        void OnMaterial(MaterialComponent material)
        {
            ...
            if (shaderEffects.ContainsKey(CurrentNode.Name)) shaderName = CurrentNode.Name;
    ...
    public class Tutorial : RenderCanvas
    {
        ...
        public override void Init()
        {
            ...
            _renderer = new Renderer(RC, new []{"Leaves.jpg"});
            _renderer.AddShader("standard", new ShaderEffect(
                new[]
                {
                ...
                new[]
                {
                    ...
                    new EffectParameterDeclaration {Name = "texture", Value = _renderer.GetTexture("Leaves.jpg")},
